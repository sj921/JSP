...
<body>
	...
	<ul>
		<li>서버로 요청을 보낼 때 데이터를 함께 보내기 위한 태그</li>
		<li>
		...
		<li>GET 방식과 POST 방식 중 원하는 방식을 선택할 수 있다</li>
	</ul>
	...
	<ul>
		...
		<li>주소창에 URL을 직접 입력하거나,
			링크를 클릭하는 방식은 기본적으로 GET방식이다</li>
	</ul> 
	...
	<form action="http://localhost:9000/chap02/test1" method="GET">
		취미 : <input type="text" name="hobby" value="movie"> <br>
		버블티 : <input type="text" name="boba" value="taro"> <br> 
		커피 : <input type="text" name="coffee" value="americano"> <br>
	...
	<ul>
		...
		<li>
			...
			(패킷을 열어보는 모든 정보를 볼 수는 있다)
		</li>
		<li>request 객체의 body라는 필드에 실려서 전송된다</li>	
		<li>비밀번호 같은 것들은 GET방식으로 보내면 다 보이기 때문에 
			POST방식을 이용해야 한다</li>
	</ul>
	...
	<!-- 
		...
		현재 주소가 /chap02/form/index.jsp일 때
