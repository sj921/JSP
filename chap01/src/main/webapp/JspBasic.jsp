...
<body>
	...
	<ul>
		...
		<li>HTML 안에 원하는 대로 Java 코드를 마음껏 넣을 수 있다</li>
	</ul>
	...
	<ul>
		...
		<li>변환된 자바 코드를 컴파일하여 웹 컨테이너(Tomcat)에 등록한다</li>
		<li>
			클라이언트가 해당 페이지를 요청할 때마다 웹 컨테이너에 등록되어 있는
			컴파일 결과물을 실행하여 생성되는 HTML코드를 응답한다.
			(.jsp의 컴파일 결과물은 실행하면 HTML코드를 반환하는 프로그램이다)
		</li>
	</ul>
